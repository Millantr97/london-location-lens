"""Emit segments.js + units.js + competitors.js from segments_full2.json (area + street levels)."""
...
print('segments:',len(segs),'| units:',len(UNITS),'| competitors segs:',len(COMPS))
